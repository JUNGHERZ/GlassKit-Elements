// ============================================================
// GlassKit Elements – Package Contents
//
// Checks what `npm pack` would publish: every entry point of
// package.json (main, module, exports), the documents the README
// sends a reader to (SKILL.md, CHANGELOG.md), and any source map a
// shipped file names. Up to 1.19.0 the package went out without
// SKILL.md and CHANGELOG.md — `files` listed dist/, src/ and LICENSE
// only — so an agent reading SKILL.md from node_modules found none.
// The same check as NotionKit Elements' check:package.
//
...
const REQUIRED = ['package.json', 'README.md', 'LICENSE', 'CHANGELOG.md', 'SKILL.md', 'dist/glasskit-elements.min.js', 'src/index.js'];
...
for (const file of new Set([...REQUIRED, pkg.main, pkg.module, pkg.style, ...targets(pkg.exports)].filter(Boolean))) {
