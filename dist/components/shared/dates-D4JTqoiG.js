...
const weekdayShort = (f, d) => f.weekday.format(d).replace(/\.$/, '');
...
const isTone = v => typeof v === 'string' && /^[a-z][a-z0-9-]*$/.test(v);

export { firstWeekday as a, parseJsonObject as b, addDays as c, isTone as d, formatters as f, isoDate as i, parseIso as p, resolveLocale as r, weekdayShort as w };
